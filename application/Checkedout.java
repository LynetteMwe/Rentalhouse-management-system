...
public class Checkedout extends javax.swing.JFrame {
    ...
    public Checkedout() {
     ...
     public void tableFill(){
        ...
        try {
            ...
            String q="SELECT * FROM `tenants_checkout`";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHECKED OUT TENANTS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Checkedout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
